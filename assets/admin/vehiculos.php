...
$consultaVehiculos = mysqli_query($mysqli, "SELECT * FROM vehiculos");
...
<section class="courses">
   ...
   <h1 class="heading">Vehiculos del sistema</h1>

   <div class="box-container">

      <?php
      // Iterar sobre los resultados de la consulta de vehículos
      while ($vehiculo = mysqli_fetch_assoc($consultaVehiculos)) {
      ?>
         <div class="box">
            <div class="tutor">
               <!-- Puedes mostrar la información del vehículo aquí -->
               <h3><?php echo $vehiculo['marcaVehiculo'] . ' ' . $vehiculo['modeloVehiculo']; ?></h3>
               <span><?php echo $vehiculo['ano']; ?></span>
            </div>
            <div class="thumb">
               <!-- Puedes mostrar la imagen del vehículo aquí -->
               <img src="../img/<?php echo $vehiculo['imagen']; ?>" alt="<?php echo $vehiculo['marca'] . ' ' . $vehiculo['modelo']; ?>">
   ...
   <button type="buttonClientes" class="btn btn-primary" onclick="location.href='../crud/agregarVehiculo.php'" >Agregar Vehículo</button>
