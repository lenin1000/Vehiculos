...
<div class="row mt-4">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<th scope='row'>" . $row['id_repuesto'] . "</th>";
                        echo "<td>" . $row['nombreRepuesto'] . "</td>";
                        echo "<td>" . $row['MarcaRepuesto'] . "</td>";
                        echo "<td>" . $row['Asignado'] . "</td>";


                        echo "<td>";
                        echo "<a class='btnEditar' href='crud-admin-repuesto-editar.php?editarid=" . $row['id_repuesto'] . "'>Editar</a>";
                        echo "<a class='btnEliminar' href='crud-admin-repuesto-eliminar.php?deleteid=" . $row['id_repuesto'] . "'>Eliminar</a>";
                        echo "</td>";
    ...
    <button type="buttonClientes" class="btn btn-primary" onclick="location.href='../crud/agregarRepuesto.php'" >Agregar</button>
