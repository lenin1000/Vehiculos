...
<div class="row mt-4">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<th scope='row'>" . $row['id_mecanico'] . "</th>";
                        echo "<td>" . $row['cedulaMecanico'] . "</td>";
                        echo "<td>" . $row['nombreMecanico'] . "</td>";
                        echo "<td>" . $row['telefonoMecanico'] . "</td>";


                        echo "<td>";
                        echo "<a class='btnEditar' href='crud-admin-mecanico-editar.php?editarid=" . $row['cedulaMecanico'] . "'>Editar</a>";
                        echo "<a class='btnEliminar' href='crud-admin-mecanico-eliminar.php?deleteid=" . $row['cedulaMecanico'] . "'>Eliminar</a>";
                        echo "</td>";
    ...
    <button type="buttonClientes" class="btn btn-primary" onclick="location.href='../crud/agregarMecanico.php'" >Agregar</button>
