...
<form action="" method="post">
          ...
          <input type="hidden" name="" id="action" value="Agregar">
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label"style="font-size:20px">Nombre Repuesto</label>
                <div class="col-sm-6">
                        <input type="text" class="nombretxt form-control"style="font-size:20px" placeholder="Nombre Repuesto" id="nombretxt" name="nombretxt"  >
                </div>
            </div> 

            <div class="row mb-3">
                <label class="col-sm-3 col-form-label" style="font-size:20px" >MarcaRepuesto</label>
                <div class="col-sm-6">
                        <input type="text" class="marcatxt form-control"style="font-size:20px" placeholder="Marca Repuesto" id="marcatxt" name="marcatxt" >
                </div>
            </div>
    ...
    <div class="col-sm-6">
        <select class="clasificaciontxt form-select" style="font-size: 20px" id="clasificaciontxt" name="clasificaciontxt">
        ...
        <button type="button" class="btn btn-secondary" onclick="location.href='../admin/repuestos.php'">Regresar</button>
...
<?php require "../Scripts/mainAgregarRepuesto.php"; ?>
