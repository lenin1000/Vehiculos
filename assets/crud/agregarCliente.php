...
<form action="" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                        <input type="text" class="direcciontxt form-control"style="font-size:20px" placeholder="Dirección" id="direcciontxt" name="Correo" >
                </div>
            </div>
        ...
        <button type="button" class="btn btn-secondary" onclick="location.href='../admin/clientes.php'">Regresar</button>
...
<?php require "../Scripts/mainAgregarCliente.php"; ?>
